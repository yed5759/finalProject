...
def main():
    ...
    parser.add_argument('--onset-pos-weight', type=float, default=50.0,
                        help='Positive class weight for onset detection (higher values emphasize note detection)')
    parser.add_argument('--offset-pos-weight', type=float, default=50.0,
    ...
    parser.add_argument('--min-activation-target', type=float, default=0.2,
                        help='Target for minimum activation loss')
    parser.add_argument('--activation-loss-weight', type=float, default=0.5,
